...
public class App extends Application {
    private Map<String, String> userCredentials = new HashMap<>();   ///utk menyimpan pasangan user and pass
    ...
    private Scene mainMenuScene(Stage stage) {
        Label judul1 = new Label("- HOLA PREN -");
    ...
    private Scene registerScene(Stage stage) {
        ...
        Label dateLabel = new Label("Hobi\t:");
        ...
        submit.setOnAction(e -> {
            ...
            if (name.isEmpty() || date.isEmpty() || username.isEmpty() || password.isEmpty()) {
                ...
                userProfiles.put(username, name + ", Hobi\t: " + date);
    ...
    private Scene registerSuccess(Stage stage) {
        Label success = new Label("Selamat, Registrasi Berhasil!");
